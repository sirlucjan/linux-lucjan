...
DROP 5.18-lucjan-ll129-rc1

5.18-lucjan-ll129-rc1
...
- update bcachefs-5.18-introduce-bcachefs-patchset.patch
- add nvme-add-bug-report-info-for-global-duplicate-id.patch

DROP 5.18-lucjan-ll128-rc1

5.18-lucjan-ll128-rc1
...
- add damon-5.18-merge-changes-from-CachyOS.patch

DROP 5.18-lucjan-ll125-rc2
...
- add amd-5.18-amd-pstate-enhancement-and-issue-fixs.patch

DROP 5.18-lucjan-ll124-rc1

5.18-lucjan-ll124-rc1
...
- add ACPI-CPPC-Fix-enabling-CPPC-on-AMD-systems-with-shar.patch

DROP 5.18-lucjan-ll122-rc1

5.18-lucjan-ll122-rc1
...
- add hwmon-asus-ec-sensors-add-missing-sensors-for-X570-I.patch
- add hwmon-asus-ec-sensors-add-definitions-for-ROG-ZENITH.patch

DROP 5.18-lucjan-ll121-rc1

5.18-lucjan-ll121-rc1
...
DROP 5.18-lucjan-ll119-rc1

5.18-lucjan-ll119-rc1

- sync with upstream (update perf-5.18-merge-changes-from-dev-tree.patch)
- sync with upstream (update randstruct-Split-randstruct-Makefile-and-CFLAGS.patch)

5.18-lucjan-ll118-rc1 --> 5.18-lucjan-ll118

5.18-lucjan-ll118-rc1

- sync with upstream (drop i2c-piix4-Fix-a-memory-leak-in-the-EFCH-MMIO-support.patch)

5.18-lucjan-ll117

- update modules-5.18-merge-changes-from-dev-tree.patch

DROP 5.18-lucjan-ll117-rc1

5.18-lucjan-ll117-rc1

- sync with upstream (drop i2c-piix4-Fix-a-memory-leak-in-the-EFCH-MMIO-support.patch)

5.18-lucjan-ll116

- add zonefs-Call-page_address-on-page-acquired-with-GFP_K.patch

DROP 5.18-lucjan-ll116-rc1

5.18-lucjan-ll116-rc1
...
5.18-lucjan-ll113-rc1 --> 5.18-lucjan-ll113

5.18-lucjan-ll113-rc1

- sync with upstream (drop platform-x86-thinkpad_acpi-Fix-a-memory-leak-of-EFCH.patch)

5.18-lucjan-ll112

- add Revert-Add-a-sysctl-to-skip-tcp-collapse-processing-.patch

DROP 5.18-lucjan-ll112-rc1

5.18-lucjan-ll112-rc1

- sync with upstream (drop platform-x86-thinkpad_acpi-Fix-a-memory-leak-of-EFCH.patch)

5.18-lucjan-ll111

- add add-a-sysctl-to-enable-disable-tcp_collapse-logic.patch

DROP 5.18-lucjan-ll111-rc1
...
- update media-v4l2-core-add-v4l2loopback.patch
...
- drop clearlinux-5.18-introduce-clearlinux-patchset.patch
- add modules-5.18-merge-changes-from-dev-tree.patch
- update bcachefs-5.18-introduce-bcachefs-patchset.patch

5.18-lucjan-ll102

- add perf-5.18-merge-changes-from-dev-tree.patch
...
- add arm64-boot-add-zstd-support.patch
...
DROP 5.18-lucjan-ll93-rc1

5.18-lucjan-ll93-rc1
...
DROP 5.18-lucjan-ll92-rc1

5.18-lucjan-ll92-rc1
...
DROP 5.18-lucjan-ll87-rc1

5.18-lucjan-ll87-rc1
...
DROP 5.18-lucjan-ll85-rc1

5.18-lucjan-ll85-rc1
...
DROP 5.18-lucjan-ll79-rc1

5.18-lucjan-ll79-rc1
...
DROP 5.18-lucjan-ll78-rc1

5.18-lucjan-ll78-rc1
...
- drop cacULE-5.18.patch

DROP 5.18-lucjan-ll77-rc1

5.18-lucjan-ll77-rc1
...
DROP 5.18-lucjan-ll75-rc1

5.18-lucjan-ll75-rc1
...
DROP 5.18-lucjan-ll74-rc1

5.18-lucjan-ll74-rc1
...
DROP 5.18-lucjan-ll73-rc1

5.18-lucjan-ll73-rc1
...
- update bcachefs-5.18-introduce-bcachefs-patchset.patch
- add 5.18-bfq-lucjan-r2K220619v1.patch
...
- add btrfs-add-error-messages-to-all-unrecognized-mount-o.patch
...
- add HID-apple-Properly-handle-function-keys-on-Keychron-.patch

DROP 5.18-lucjan-ll53-rc1

5.18-lucjan-ll53-rc1
...
- add KVM-x86-Grab-regs_dirty-in-local-unsigned-long.patch
- add KVM-x86-Harden-_regs-accesses-to-guard-against-buggy.patch

DROP 5.18-lucjan-ll52-rc1

5.18-lucjan-ll52-rc1
...
DROP 5.18-lucjan-ll50-rc1

5.18-lucjan-ll50-rc1
...
- sync with upstream (drop net-sched-add-barrier-to-fix-packet-stuck-problem-fo.patch)
- sync with upstream (drop writeback-Fix-inode-i_io_list-not-be-protected-by-in.patch)
- sync with upstream (add lrng-5.18-drop-EXPORT_SYMBOL_GPL-add_bootloader_rand.patch)
- sync with upstream (update kbuild-5.18-merge-changes-from-dev-tree.patch)
...
5.18-lucjan-ll44-rc1 --> 5.18-lucjan-ll44

5.18-lucjan-ll44-rc1
...
- sync with upstream (drop arm64-stackleak-fix-current_top_of_stack.patch)
- sync with upstream (drop binfmt_flat-do-not-stop-relocating-GOT-entries-prema.patch)
...
- add bfq-Relax-waker-detection-for-shared-queues.patch
...
- add modpost-move-export_from_secname-call-to-more-releva.patch
...
- sync with upstream (drop random-treat-bootloader-trust-toggle-the-same-way-as.patch)
...
- add random-treat-bootloader-trust-toggle-the-same-way-as.patch
...
- add mt76-mt7921-reduce-log-severity-levels-for-informati.patch

DROP 5.16-lucjan-ll39-rc1

5.16-lucjan-ll39-rc1

- sync with upstream (drop block-wbt-fix-negative-inflight-counter-when-remove-.patch)

5.16-lucjan-ll38

- add netfilter-nf_tables_offload-incorrect-flow-offload-a.patch

DROP 5.16-lucjan-ll38-rc1

5.16-lucjan-ll38-rc1
...
DROP 5.16-lucjan-ll37-rc1

5.16-lucjan-ll37-rc1
...
5.16-lucjan-ll31-rc1 --> 5.16-lucjan-ll31

5.16-lucjan-ll31-rc1
...
5.16-lucjan-ll27-rc1 --> 5.16-lucjan-ll27

5.16-lucjan-ll27-rc1
...
DROP 5.16-lucjan-ll25-rc1

5.16-lucjan-ll25-rc1
...
- add Revert-btrfs-use-single-variable-to-track-return-val.patch
- add Revert-btrfs-avoid-inode-logging-during-rename-and-l.patch
- add btrfs-avoid-inode-logging-during-rename-and-link-whe.patch
- add btrfs-use-single-variable-to-track-return-value-at-b.patch
- add btrfs-get-rid-of-warning-on-transaction-commit-when-.patch

5.16-lucjan-ll21

- add lib-zstd-clean-up-double-word-in-comment.patch
...
- add Revert-sched-alt-Alfred-Chen-s-PoC-sched_preferred_c.patch
...
- Revert-bfq-fix-use-after-free-in-bfq_dispatch_reques.patch (2)
...
- add bbr2-5.16-introduce-BBRv2.patch
- add bbr2-5.16-clean-up-forward-port.patch
- add block-elevator-remove-un-used-input-parameter-reques.patch
...
- add bloc-bfq-update-comments.patch
- add bfq-Avoid-false-marking-of-bic-as-stably-merged.patch
- add bfq-Avoid-merging-queues-with-different-parents.patch
...
- add blk-make-blk-rq-qos-support-pluggable-and-modular-po.patch
- add blk-wbt-make-wbt-pluggable.patch
- add blk-export-following-interfaces.patch
- add cgroup-export-following-two-interfaces.patch
- add blk-iolatency-make-iolatency-pluggable-and-modular.patch
- add blk-remove-unused-BLK_RQ_IO_DATA_LEN.patch
- add blk-use-standalone-macro-to-control-bio.bi_iocost_co.patch
- add blk-iocost-make-iocost-pluggable-and-modular.patch
- add blk-rename-ioprio.c-to-ioprio-common.c.patch
- add blk-ioprio-make-ioprio-pluggable-and-modular.patch
- add blk-remove-unused-interfaces-of-blk-rq-qos.patch
- add blk-make-request-able-to-carry-blkcg_gq.patch
- add blk-introduce-iostat-per-cgroup-module.patch
- add block-Kconfig.iosched-set-default-value-of-IOSCHED_B.patch
- add block-Fix-depends-for-BLK_DEV_ZONED.patch
- add block-set-rq_affinity-2-for-full-multithreading-I-O.patch
- add btrfs-add-a-force_chunk_alloc-to-space_info-s-sysfs.patch
...
- add don-t-report-an-error-if-PowerClamp-run-on-other-CPU.patch
- add Port-microcode-patches.patch
- add clearlinux-5.16-backport-patches-from-clearlinux-rep.patch
- add cpu-5.16-merge-graysky-s-patchset.patch
- add init-Kconfig-enable-O3-for-all-arches.patch
- add init-Kconfig-add-O1-flag.patch
- add Makefile-Turn-off-loop-vectorization-for-GCC-O3-opti.patch
...
- add Documentation-amd-pstate-Add-AMD-P-State-driver-intr.patch
- add MAINTAINERS-Add-AMD-P-State-driver-maintainer-entry.patch
- add cpufreq-amd-pstate-Fix-struct-amd_cpudata-kernel-doc.patch
- add cpufreq-amd-pstate-Fix-the-dependence-issue-of-AMD-P.patch
- add x86-sched-Fix-the-undefined-reference-building-error.patch
- add f2fs-compress-reduce-one-page-array-alloc-and-free-w.patch
- add f2fs-rework-write-preallocations.patch
- add f2fs-reduce-indentation-in-f2fs_file_write_iter.patch
- add f2fs-do-not-expose-unwritten-blocks-to-user-by-DIO.patch
- add f2fs-fix-the-f2fs_file_write_iter-tracepoint.patch
- add f2fs-implement-iomap-operations.patch
- add f2fs-use-iomap-for-direct-I-O.patch
- add f2fs-show-more-DIO-information-in-tracepoint.patch
- add f2fs-fix-remove-page-failed-in-invalidate-compress-p.patch
- add f2fs-support-POSIX_FADV_DONTNEED-drop-compressed-pag.patch
- add f2fs-show-number-of-pending-discard-commands.patch
- add f2fs-avoid-duplicate-call-of-mark_inode_dirty.patch
- add f2fs-fix-to-do-sanity-check-on-inode-type-during-gar.patch
- add f2fs-fix-to-avoid-panic-in-is_alive-if-metadata-is-i.patch
- add f2fs-fix-to-do-sanity-check-in-is_alive.patch
- add f2fs-add-gc_urgent_high_remaining-sysfs-node.patch
- add f2fs-avoid-EINVAL-by-SBI_NEED_FSCK-when-pinning-a-fi.patch
- add f2fs-compress-fix-potential-deadlock-of-compress-fil.patch
- add f2fs-avoid-down_write-on-nat_tree_lock-during-checkp.patch
- add f2fs-do-not-bother-checkpoint-by-f2fs_get_node_info.patch
- add f2fs-fix-to-do-sanity-check-on-last-xattr-entry-in-_.patch
- add f2fs-clean-up-__find_inline_xattr-with-__find_xattr.patch
- add f2fs-support-fault-injection-to-f2fs_trylock_op.patch
- add f2fs-fix-to-check-available-space-of-CP-area-correct.patch
- add f2fs-fix-to-reserve-space-for-IO-align-feature.patch
- add f2fs-don-t-drop-compressed-page-cache-in-.-invalidat.patch
- add f2fs-Simplify-bool-conversion.patch
- add f2fs-remove-redunant-invalidate-compress-pages.patch
- add f2fs-move-f2fs-to-use-reader-unfair-rwsems.patch
- add f2fs-do-not-allow-partial-truncation-on-pinned-file.patch
- add fs-f2fs-data.c-fix-mess.patch
- add fix-mess-2.patch
- add net-sched-allow-configuring-cake-qdisc-as-default.patch
- add infiniband-Fix-__read_overflow2-error-with-O3-inlini.patch
- add pci-Enable-overrides-for-missing-ACS-capabilities.patch
- add scsi-sd-Optimal-I-O-size-should-be-a-multiple-of-rep.patch
...
- add tty-Allow-setting-the-number-of-available-virtual-TT.patch
- add i2c-busses-Add-SMBus-capability-to-work-with-OpenRGB.patch
- add fm-5.16-port-mm-kswapd-patches.patch
- add Disable-stack-conservation-for-GCC.patch
...
- add mm-5.16-protect-mappings-under-memory-pressure.patch
...
- add kbuild-allow-setting-ultra-zstd-compression-level-fo.patch
- add kbuild-add-menu-for-ZSTD-module-compression-options.patch
- add Project-C v5.16-r0
- add sched-alt-Export-can_nice-symbol-for-Android-Binder-.patch
- add sched-alt-Add-MG-LRU-changes-through-ifdef-macro.patch
- add init-Kconfig-set-default-value-of-SCHED_PDS.patch
- add init-Kconfig-Restore-original-PDS-description.patch
- add LL-Add-.ll-version.patch
- add LL-Implement-ll-branding-v5.16.patch
- add LL-kconfig-add-750Hz-timer-interrupt-kernel-config-o.patch
- add Disable-CPU_FREQ_GOV_SCHEDUTIL.patch
- add spadfs-5.16-merge-v1.0.15.patch
...
- sync with upstream (update mm-damon-dbgfs-support-physical-memory-monitoring.patch)

5.15-lucjan-ll107

- add bfq-Fix-__bfq_lookup_next_entity-kernel-doc-comment.patch

DROP 5.15-lucjan-ll107-rc1

5.15-lucjan-ll107-rc1
...
DROP 5.15-lucjan-ll106-rc1

5.15-lucjan-ll106-rc1
...
- add bfq-5.15-block-bfq-minor-cleanup-and-fix-v2.patch

5.15-lucjan-ll103

- add Revert-ksmbd-force-fail-immediately-flag-on-fs-with-.patch

5.15-lucjan-ll102-rc1 --> 5.15-lucjan-ll102
